...
$conn = new mysqli($host, $user, $password, $db_name);
    ...
    echo "<tr><th>Recipe Name</th><th>Rating</th> <th>image</th><th>AddtoFavs</th> </tr>";
        if ($result) {
        ...
        while ($row = $result->fetch_assoc() ) {
            ...
            if($rating==null)
            {
                ...
                <td>
                <button type='submit' name='submit'  value=".$row['recipe_id'].">fav</button>
                </td>
              </form>
            </tr>";
...

            {
              ...
              <td>
              <form action='viewrecipes.php' method='post'>
